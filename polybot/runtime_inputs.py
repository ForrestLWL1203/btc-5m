...
RUNTIME_INPUT_FIELDS: tuple[RuntimeInputField, ...] = (
    ...
    RuntimeInputField(
        ...
        minimum=1,
        maximum=20,
        description="Deepest ask-book level scanned for the BUY price hint",
        ui_exposed=False,
    ...
    RuntimeInputField(
        name="stop_loss_trigger_drop_pct",
        config_path=("params", "stop_loss", "trigger_drop_pct"),
        value_type="float",
        minimum=0.0,
        maximum=0.99,
        description="Dynamic stop trigger as entry-price drop fraction",
        ui_exposed=False,
        cli_flag="--stop-loss-trigger-drop-pct",
        coerce=float,
    ),
    RuntimeInputField(
