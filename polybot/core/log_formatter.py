    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if hasattr(record, "event_type") and hasattr(record, "event_data"):
            ...
            for key in (
                ...
                "depth_notional", "signed_limit_price", "maker_amount",
                "taker_amount", "signed_side", "post_order_ms", "total_ms", "attempt_ms",
                "best_ask_age_ms",
                "entry_ask_level", "best_ask_level_1", "target_entry_ask",
                "depth_skip_count", "depth_skip_min_best_ask",
                "depth_skip_max_best_ask", "depth_skip_min_entry_ask",
                "depth_skip_max_entry_ask", "depth_skip_max_notional",
