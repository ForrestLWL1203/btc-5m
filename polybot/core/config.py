...
DRY_RUN_SIMULATED_FAK_LATENCY_SEC: float = 0.4  # approximate VPS signal-to-order latency for dry stop-loss sells
DRY_RUN_SIMULATED_PRICE_BUFFER_TICKS: float = 5.0  # pessimistic dry stop-loss sell fill buffer
